...
class SpecSubED():
    ...
    def spec_sub(self, signal_in):
        ...
        outSignal = self.decrypted_normalization( outSignal)
        return outSignal
    ...
    def overlap_add(self, sptrRe, sptrIm): # NIS^0.5 * Q^15
        ...
        outSignal = [self.pbk.encrypt(0)] * self.Len_message 
    ...
    def decrypted_normalization(self, out):
        sigout=[float(self.pvk.decrypt(i)/ self.Q ** 13) for i in out]
